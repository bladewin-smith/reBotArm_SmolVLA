...
def main() -> None:
    ...
    parser.add_argument("--enabled-joints", type=_parse_names, default=_parse_names("joint_2"))
    parser.add_argument("--torque-scale", type=float, default=0.25)
    parser.add_argument("--torque-limit", type=float, default=2.0)
    parser.add_argument("--kp", type=_parse_gain, default=0.5)
    parser.add_argument("--kd", type=_parse_gain, default=0.2)
